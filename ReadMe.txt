...
1. В диалоговое окно выбора шрифта добавить кнопку 'Применить',
   которая будет примнять заданный размен шрифта к 'labelExample';
2. При закрытии программы, ее настройки должны сохраняться, и эти сохраненные настройки 
   должны применяться при следующем запуске;
